/*
لو احتجت اي مساعده تعال ديسكورد
sukr~🍻#0011
https://discord.gg/Xa9EAwfGDX
*/
...
require('http').createServer((req, res) => res.end(`
 ...
 |• Author: sukr~🍻#0011                   |
 |-----------------------------------------|
 |• Server: https://discord.gg/Xa9EAwfGDX  |
 |-----------------------------------------|
...
client.login("MTAxMTY3NTQ3MTI5NTAyOTM1MQ.GZ_SHk.DU8I7YrVjP9Qk4-sV5d43YQLq6b2ZOnu19ecvI");
